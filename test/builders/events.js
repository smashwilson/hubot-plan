...
const UserBuilder = createBuilderClass()({
  id: {default: "id"},
...
const ExtendedPropertiesBuilder = createBuilderClass()({
  private: {default: {}},
  shared: {default: {}},
});

const ReminderOverrideBuilder = createBuilderClass()({
...
const EventBuilder = createBuilderClass()({
